...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=int, required=False, default=5,     help='0: Transformer_ge_mut_meth, 1: Transformer_ge_mut, 2: Transformer_meth_mut, 3: Transformer_meth_ge, 4: Transformer_ge, 5: Transformer_mut, 6: Transformer_meth')
