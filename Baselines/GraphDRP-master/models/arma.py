...
from torch_geometric.nn import ARMAConv, global_max_pool as gmp
...
class ARMA(torch.nn.Module):
    def __init__(self, n_output=1, n_filters=32, embed_dim=128,num_features_xd=78, num_features_xt=25, output_dim=128, dropout=0.5):
        ...
        self.conv1 = ARMAConv(num_features_xd, num_features_xd)
        self.conv2 = ARMAConv(num_features_xd, num_features_xd*2)
        self.conv3 = ARMAConv(num_features_xd*2, num_features_xd * 4)
