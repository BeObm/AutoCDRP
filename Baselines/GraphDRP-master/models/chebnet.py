...
class ChebNet(torch.nn.Module):
    def __init__(self, n_output=1, n_filters=32, embed_dim=128,num_features_xd=78, num_features_xt=25, output_dim=128, dropout=0.5):
        ...
        self.conv1 = ChebConv(num_features_xd, num_features_xd,2)
        self.conv2 = ChebConv(num_features_xd, num_features_xd*2,2)
        self.conv3 = ChebConv(num_features_xd*2, num_features_xd * 4,2)
