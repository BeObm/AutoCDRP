...
#------data files
Drug_info_file= '../data/Drug/dataset/raw_dir/Drug_listMon Jun 24 09_00_55 2019.csv'
...
Genomic_mutation_file= '../data/Drug/dataset/raw_dir/genomic_mutation_34673_demap_features.csv'
Cancer_response_exp_file= '../data/Drug/dataset/raw_dir/GDSC_IC50.csv'
Gene_expression_file= '../data/Drug/dataset/raw_dir/genomic_expression_561celllines_697genes_demap_features.csv'
Methylation_file= '../data/Drug/dataset/raw_dir/genomic_methylation_561celllines_808genes_demap_features.csv'
